# Mapa de Teste de Público — Canal

> Criado 2026-08-24. Substitui a definição de ICP fechado no início do canal.
> **Decisão do Emerson (24/08):** não escolher o público no papel. Publicar para descobrir.
>
> Este arquivo é a hipótese. `icp-audience.md` só será preenchido quando os dados de 4-8 vídeos apontarem um vencedor — provavelmente depois de 30/10.

---

## A decisão

Escolher ICP no papel, com zero vídeo publicado, é chutar. Emerson optou por testar.

**Mas testar sem eixo comum vira canal sem identidade** — o YouTube não sabe pra quem entregar, e o método (Aula 05, gerador nº 5) diz que mudar de posicionamento constantemente é o erro que mais enfraquece marca.

**Solução:** eixo fixo, públicos variáveis.

### Eixo fixo do canal — não muda durante o teste

> **IA aplicada a trabalho que já existe.**
> Não é IA para criar negócio novo. É IA para tirar trabalho manual de quem já trabalha.

Os 4 pilares que o Emerson escolheu (WhatsApp com IA, n8n, saber pedir certo, dados que o negócio já tem) cabem todos aqui. Isso permite variar o **público** sem trocar de canal.

### Tom fixo — não muda durante o teste

**Direto e sem hype.** Fato, número, sem promessa de resultado garantido. Diferencia de ~90% do conteúdo de IA no YouTube BR, que vende milagre.

Ver `brand-voice.md`.

---

## Os 5 públicos em teste

| # | Público | Dor central | Por que testar | Risco |
|---|---|---|---|---|
...
## Os 4 pilares × os públicos

Cada pilar fala com públicos diferentes. Esta é a matriz que gera as pautas.

| Pilar | P1 Comércio | P3 CLT | P4 Autônomo |
|---|---|---|---|
| **1. Atendimento no WhatsApp com IA** | ★★★ core | ☆ | ★★ |
| **2. Automação de processo (n8n)** | ★★ | ★★ | ★★★ |
| **3. Saber pedir certo pra IA** | ★ | ★★★ core | ★★★ |
| **4. Dados que o negócio já tem** | ★★★ | ★★ | ★ |

**Leitura:** o pilar 3 ("saber pedir certo") é o de maior alcance e menor barreira — não exige que o espectador tenha negócio. O pilar 1 é o de maior prova e menor alcance. Os dois extremos do teste.
...
## Ângulos de conteúdo — banco de partida

Classificados em Hero/Hub/Help (Aula 04) e com o tipo da Aula 02.

### P1 — Comércio local

| # | Ângulo | H | Tipo | Prova? |
|---|---|---|---|---|
| 1 | "Automatizei o atendimento de um mercado de bairro — o que deu certo e o que quebrou" | Hero | Prova real + bastidor | ✅ Araújo (anônimo até autorização) |
| 2 | "Seu WhatsApp comercial está perdendo pedido. 3 sinais" | Help | Problema do cliente | — |
| 3 | "Os 3 números que todo comércio já tem e nunca olha" | Help | Ensinar | ✅ dados do relatório A2 |
| 4 | "IA não vai substituir seu atendente — e esse é o problema" | Hero | Opinião | — |
| 5 | "Quanto custa de verdade automatizar um comércio pequeno" | Help | Comparação | ✅ budget real |

### P3 — Profissional CLT

| # | Ângulo | H | Tipo | Prova? |
|---|---|---|---|---|
| 6 | "Saber pedir certo pra IA" — a pauta Hero do radar 19/08 | Hero | Ensinar | — |
| 7 | "Por que a IA te dá resposta ruim (não é culpa da IA)" | Help | Erro comum | — |
| 8 | "3 coisas que a IA já faz sozinha no seu trabalho" | Help | Ensinar | radar 19/08 |
| 9 | "Prompt não é truque. É saber descrever o que você quer" | Hero | Opinião | — |
| 10 | "Automatizei meu relatório semanal — passo a passo" | Help | Tutorial | ✅ rotina real |

### P4 — Autônomo

| # | Ângulo | H | Tipo | Prova? |
|---|---|---|---|---|
| 11 | "Trabalho sozinho: o que eu automatizei primeiro e por quê" | Hub | Bastidor | ✅ próprio HIVE |
| 12 | "n8n em 10 minutos, sem saber programar" | Help | Tutorial | ✅ |
| 13 | "O que eu automatizei e me arrependi" | Hero | Erro / história | ✅ |

### Hub — transversal (bastidor, serve a todos)
...
- [ ] **Autorização do Araújo para citar o case** — Emerson ainda não pediu (24/08). Até lá, todo conteúdo do P1 usa "um mercado de bairro" anônimo. **Pedir na entrega do relatório de valor, 11/09 (marco A2)** — é a hora natural, o cliente vai estar vendo o resultado.
- [ ] `creator-profile.md` — posicionamento pessoal ainda incompleto (tese central, missão, diferencial). Não bloqueia o vídeo 1, mas bloqueia coerência de marca no médio prazo.
