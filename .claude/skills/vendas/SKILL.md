...
| **Prospectar · rotina do dia · funil parado** | **§2B — meta de execução · rotina em blocos · encerrar contato** ⚠️ preparo |
| Atrair, converter, fidelizar (funil inteiro) | §3 — **AIDAS completo** (A·I·D·A·S) |
| **Ler o cliente · sondar · sinais de compra · carisma** | **§3B — 8 sinais · método FREQUÊNCIA · tom por etapa · cliente resistente** |
| **Pós-venda · fidelizar · pedir indicação · reativar lead** | **§3C — janela de 30 dias · mapa de recompra · efeito especialista** |
...
| **"Achei mais barato" · mercado saturado · crise** | **§7 — 5 pilares · declaração de intenção** |
...
- **Prospecção ativa por ligação está EXCLUÍDA do trimestre** (decisão de 23/08, segue valendo). A base de 238 leads e o script estão intactos, mas parados.
  - ⚠️ **Mas reativação não é prospecção** (§3C): pedir indicação a cliente satisfeito e reabrir relacionamento com lead antigo **não violam** a suspensão — e são a única alavanca de aquisição aberta no trimestre.
...
4. **A faixa de preço** — ⚠️ o Araújo está em piloto gratuito, então a âncora dele é **zero**. Nunca apresentar R$4.000 sozinho: montar faixa com **R$4.000 no meio, nunca no topo** (§1B, comparação inteligente). E lembrar a §7: *"talvez não é que você é caro — é que você está com cara de barato"*
